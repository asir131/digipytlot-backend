...
import { assertAssignablePermissions, assertAssignableRole, createUser, getEffectivePermissions, updateUser, incrementTokenVersion, } from "../services/userService.js";
import { badRequest, notFound } from "../utils/errors.js";
export async function listUsers(req, res) {
    const { page, limit, skip } = getPagination(req.query);
    const { q, status, roleId, managerId } = req.query;
    const filter = {};
    if (q)
...
export async function getAssignablePermissions(req, res) {
